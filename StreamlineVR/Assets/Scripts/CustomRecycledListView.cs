...
namespace VRScrollView
{
  ...
  public class CustomRecycledListView : MonoBehaviour
  {
    // Cached components
    ...
    private Dictionary<int, CustomListItem> items = new Dictionary<int, CustomListItem>();
    private Stack<CustomListItem> pooledItems = new Stack<CustomListItem>();

    ICustomListViewAdapter adapter = null;
    ...
    public void SetAdapter(ICustomListViewAdapter adapter)
    {
